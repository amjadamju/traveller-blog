...
<body style="overflow-x: hidden;">
    ...
    <section class="post-head">
        ...
        <div class="color-shade">
            <div class="flex-center flex-column">
                <h3 class="post-heading h1-responsive text-center display-2 text-white">
                    <?php
                    echo $row['post_head'];
                    ?> </h3>
            </div>
    ...
    <div class="row flex-center py-3">
        <video class="video-fluid z-depth-1 py-3 col-sm-6" autoplay loop controls muted>
            <source src="img/RPReplay_Final1591438238.mp4" type="video/mp4" />
        </video>
    </div>
    <section id="feedback">
        <div class="row mt-5 mb-5 m-1">
            <div class="col-sm-6 border py-3 px-5 rounded-sm mx-auto">
                ...
                $result = $conn->query($sql);
                ?>
                <form id="review" action="post2.php" method="post">
